...
const TR = {
  ...
  'photoConsent.none': 'Kayıtlı değil', 'photoConsent.granted': 'Var', 'photoConsent.declined': 'Hasta kabul etmedi',
  ...
  'form.photoConsent': 'Görsel kullanım onayı', 'form.photoConsentDate': 'Görsel onay tarihi',
  ...
  'p.warn.anticoagulant': 'Antikoagülan', 'p.warn.smoking': 'Sigara', 'p.consent': 'Onam kapsamı', 'p.photoConsent': 'Görsel kullanım onayı', 'p.consentDoc': 'Onam belgesi', 'p.consentDoc.view': 'Belgeyi gör',
  ...
  'share.warnTitle': 'Onam kapsamı dışında', 'share.warnOk': 'Yine de paylaş',
  'share.pcTitle.none': 'Görsel kullanım onayı kayıtlı değil', 'share.pcTitle.declined': 'Hasta görsel kullanımını kabul etmemiş',
  'share.warnMsg': 'Görsel kullanım onayı: {pc}. Onam kapsamı: {c}. Bu paylaşım denetim kaydına yazılır.',
...
const EN = {
  ...
  'photoConsent.none': 'Not recorded', 'photoConsent.granted': 'Granted', 'photoConsent.declined': 'Patient declined',
  ...
  'form.photoConsent': 'Photo use consent', 'form.photoConsentDate': 'Photo consent date',
  ...
  'p.warn.anticoagulant': 'Anticoagulant', 'p.warn.smoking': 'Smoker', 'p.consent': 'Consent scope', 'p.photoConsent': 'Photo use consent', 'p.consentDoc': 'Consent document', 'p.consentDoc.view': 'View document',
  ...
  'share.warnTitle': 'Outside consent scope', 'share.warnOk': 'Share anyway',
  'share.pcTitle.none': 'Photo use consent not recorded', 'share.pcTitle.declined': 'Patient declined photo use',
  'share.warnMsg': 'Photo use consent: {pc}. Consent scope: {c}. This share is written to the audit log.',
