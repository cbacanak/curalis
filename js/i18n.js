...
const TR = {
  ...
  'swipe.call': 'Ara', 'swipe.whatsapp': 'WhatsApp', 'swipe.appt': 'Randevu', 'swipe.attended': 'Geldi', 'swipe.missed': 'Gelmedi', 'peek.photo': 'Fotoğraf çek', 'peek.compare': 'Karşılaştır',
...
const EN = {
  ...
  'swipe.call': 'Call', 'swipe.whatsapp': 'WhatsApp', 'swipe.appt': 'Appointment', 'swipe.attended': 'Attended', 'swipe.missed': 'Missed', 'peek.photo': 'Take photo', 'peek.compare': 'Compare',
