...
const TR = {
  ...
  'cam.shoot': 'Çek', 'cam.last': 'Son çekilen', 'cam.done': 'Bitti', 'cam.setDone': '{n} açı tamamlandı', 'cam.noCamera': 'Kamera açılamadı',
...
const EN = {
  ...
  'cam.shoot': 'Shoot', 'cam.last': 'Last shot', 'cam.done': 'Done', 'cam.setDone': (p) => `${pl(p.n, 'angle', 'angles')} completed`, 'cam.noCamera': 'Camera could not be opened',
