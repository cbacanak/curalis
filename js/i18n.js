...
const TR = {
  ...
  'p.photo.pickBefore': 'Bir öncesi seç', 'p.photo.pickAfter': 'bir sonrası seç', 'p.photo.sameAngle': 'Aynı açı', 'p.photo.viewer': 'Fotoğraf', 'p.photo.prev': 'Önceki', 'p.photo.next': 'Sonraki',
...
const EN = {
  ...
  'p.photo.pickBefore': 'Pick a before', 'p.photo.pickAfter': 'pick an after', 'p.photo.sameAngle': 'Same angle', 'p.photo.viewer': 'Photo', 'p.photo.prev': 'Previous', 'p.photo.next': 'Next',
