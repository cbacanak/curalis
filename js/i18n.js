...
const TR = {
  ...
  'p.photo.deleted': 'Fotoğraf silindi', 'p.cmp.share': 'Dışa Aktar', 'p.cmp.side': 'Yan yana', 'p.cmp.slide': 'Kaydır', 'p.cmp.overlay': 'Üst üste',
...
const EN = {
  ...
  'p.photo.deleted': 'Photo deleted', 'p.cmp.share': 'Export', 'p.cmp.side': 'Side by side', 'p.cmp.slide': 'Slider', 'p.cmp.overlay': 'Overlay',
