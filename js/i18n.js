...
const TR = {
  ...
  'common.undo': 'Geri al', 'undo.restored': 'Geri alındı', 'undo.patientDeleted': '{name} silindi', 'undo.procDeleted': 'İşlem silindi', 'undo.photoDeleted': 'Fotoğraf silindi', 'undo.apptDeleted': 'Randevu silindi', 'undo.missed': 'Gelmedi olarak işaretlendi',
  'swipe.call': 'Ara', 'swipe.whatsapp': 'WhatsApp', 'swipe.appt': 'Randevu', 'swipe.attended': 'Geldi', 'swipe.missed': 'Gelmedi', 'swipe.done': 'Yapıldı', 'swipe.redate': 'Tarihi değiştir', 'swipe.reschedule': 'Yeniden planla', 'peek.photo': 'Fotoğraf çek', 'peek.compare': 'Karşılaştır',
  ...
  'consent.none': 'Kayıtlı değil', 'consent.declined': 'Hasta kabul etmedi', 'consent.treatment': 'Tedavi', 'consent.treatment_education': 'Tedavi + eğitim', 'consent.treatment_education_marketing': 'Tedavi + eğitim + tanıtım',
  ...
  'form.appt.period': 'Dönem', 'form.appt.period.none': 'Yok',
  ...
  'p.deleteHint': 'Onaylamak için hastanın adını yazın: {name}', 'p.deleted': 'Hasta silindi', 'p.procAdded': 'İşlem eklendi', 'p.procAddedControls': 'İşlem eklendi · {n} kontrol planlandı', 'p.apptAdded': 'Randevu eklendi',
  ...
  'p.warn.label': 'Tıbbi uyarı', 'p.risk.label': 'Risk faktörü', 'p.warn.anticoagulant': 'Antikoagülan', 'p.warn.smoking': 'Sigara', 'p.consent': 'Onam kapsamı', 'p.consentDoc': 'Onam belgesi', 'p.consentDoc.view': 'Belgeyi gör',
  ...
  'p.photo.deleted': 'Fotoğraf silindi', 'p.cmp.share': 'Dışa Aktar', 'p.cmp.otherAngle': 'Bu dönemde aynı açıda fotoğraf yok', 'p.cmp.side': 'Yan yana', 'p.cmp.slide': 'Kaydır', 'p.cmp.overlay': 'Üst üste',
  'p.cmp.timeline': 'Dönem şeridi', 'p.cmp.change': 'Değiştir', 'p.cmp.opacity': 'Opaklık', 'p.cmp.pickAfter': 'Sonrası fotoğrafını seç', 'p.cmp.noAfter': 'Seçilebilecek sonrası fotoğrafı yok',
  'photo.menuTitle': 'Fotoğraf ekle', 'photo.camera': 'Kamera ile çek', 'photo.gallery': 'Galeriden seç',
  'pick.today': 'Bugün randevusu olanlar', 'pick.recent': 'Son 5', 'pick.all': 'Tümü',
  'cam.title': 'Kamera', 'cam.pickPatient': 'Hangi hasta için?', 'cam.ghost': 'Önceki fotoğraf (hayalet)', 'cam.grid': 'Izgara', 'cam.level.flat': 'Düz', 'cam.level.tilted': 'Eğik', 'cam.level': 'Seviye çizgisini aç',
  ...
  'share.purposeTitle': 'Dışa aktarma amacı', 'share.education': 'Eğitim / meslektaş', 'share.marketing': 'Tanıtım (sosyal medya, web)', 'share.noConsent': 'Onam bu kullanımı kapsamıyor',
  'share.warnOk': 'Yine de dışa aktar',
  'share.warnTitle.scope': 'Onam kapsamı dışında', 'share.warnTitle.none': 'Onam kayıtlı değil', 'share.warnTitle.declined': 'Hasta görsel kullanımını kabul etmemiş',
  'share.warnMsg': 'Onam kapsamı: {c}. Bu dışa aktarma denetim kaydına yazılır.',
  'share.cleaned': 'EXIF, konum ve cihaz bilgisi kaldırıldı. Yüz görünür kalır.',
  'p.cmp.file': 'karsilastirma.jpg', 'p.cmp.title': 'Karşılaştırma', 'p.cmp.downloaded': 'Görsel indirildi', 'p.cmp.shareFail': 'Dışa aktarma hazırlanamadı',
  // Ayarlar
  ...
  'trash.purgeAll': 'Çöp kutusunu boşalt', 'trash.purgeAllQ': 'Çöp kutusu boşaltılsın mı?', 'trash.purgeAllMsg': '{n} kayıt kalıcı olarak silinecek. Bu işlem geri alınamaz.', 'trash.purgeAllOk': 'Kalıcı olarak sil', 'trash.purgedAll': 'Çöp kutusu boşaltıldı',
  ...
  'audit.purge': 'Kalıcı silindi', 'audit.share': 'Dışa aktarıldı', 'audit.backup': 'Yedek alındı', 'audit.restore_backup': 'Yedek geri yüklendi', 'audit.wipe': 'Tüm veriler silindi', 'audit.bulk': '{n} kayıt',
  ...
  's.version': 'Curalis · sürüm {v} · şema v{s}',
  // Kilit
...
const EN = {
  ...
  'common.undo': 'Undo', 'undo.restored': 'Restored', 'undo.patientDeleted': '{name} deleted', 'undo.procDeleted': 'Procedure deleted', 'undo.photoDeleted': 'Photo deleted', 'undo.apptDeleted': 'Appointment deleted', 'undo.missed': 'Marked as missed',
  'swipe.call': 'Call', 'swipe.whatsapp': 'WhatsApp', 'swipe.appt': 'Appointment', 'swipe.attended': 'Attended', 'swipe.missed': 'Missed', 'swipe.done': 'Done', 'swipe.redate': 'Change date', 'swipe.reschedule': 'Reschedule', 'peek.photo': 'Take photo', 'peek.compare': 'Compare',
  ...
  'consent.none': 'Not recorded', 'consent.declined': 'Patient declined', 'consent.treatment': 'Treatment', 'consent.treatment_education': 'Treatment + education', 'consent.treatment_education_marketing': 'Treatment + education + marketing',
  ...
  'form.appt.period': 'Period', 'form.appt.period.none': 'None',
  ...
  'p.deleteHint': 'Type the patient\'s name to confirm: {name}', 'p.deleted': 'Patient deleted', 'p.procAdded': 'Procedure added', 'p.procAddedControls': (p) => `Procedure added · ${pl(p.n, 'follow-up', 'follow-ups')} scheduled`, 'p.apptAdded': 'Appointment added',
  ...
  'p.warn.label': 'Medical warning', 'p.risk.label': 'Risk factor', 'p.warn.anticoagulant': 'Anticoagulant', 'p.warn.smoking': 'Smoker', 'p.consent': 'Consent scope', 'p.consentDoc': 'Consent document', 'p.consentDoc.view': 'View document',
  ...
  'p.photo.deleted': 'Photo deleted', 'p.cmp.share': 'Export', 'p.cmp.otherAngle': 'No photo at the same angle in this period', 'p.cmp.side': 'Side by side', 'p.cmp.slide': 'Slider', 'p.cmp.overlay': 'Overlay',
  'p.cmp.timeline': 'Period strip', 'p.cmp.change': 'Change', 'p.cmp.opacity': 'Opacity', 'p.cmp.pickAfter': 'Choose the after photo', 'p.cmp.noAfter': 'No after photo to choose from',
  'photo.menuTitle': 'Add photo', 'photo.camera': 'Take with camera', 'photo.gallery': 'Choose from gallery',
  'pick.today': 'With an appointment today', 'pick.recent': 'Recent 5', 'pick.all': 'All',
  'cam.title': 'Camera', 'cam.pickPatient': 'Which patient?', 'cam.ghost': 'Previous photo (ghost)', 'cam.grid': 'Grid', 'cam.level.flat': 'Level', 'cam.level.tilted': 'Tilted', 'cam.level': 'Enable level line',
  ...
  'share.purposeTitle': 'Purpose of export', 'share.education': 'Education / colleagues', 'share.marketing': 'Marketing (social media, web)', 'share.noConsent': 'Consent does not cover this use',
  'share.warnOk': 'Export anyway',
  'share.warnTitle.scope': 'Outside consent scope', 'share.warnTitle.none': 'Consent not recorded', 'share.warnTitle.declined': 'Patient declined photo use',
  'share.warnMsg': 'Consent scope: {c}. This export is written to the audit log.',
  'share.cleaned': 'EXIF, location and device information removed. The face remains visible.',
  'p.cmp.file': 'comparison.jpg', 'p.cmp.title': 'Comparison', 'p.cmp.downloaded': 'Image downloaded', 'p.cmp.shareFail': 'Could not prepare the export',
  ...
  'trash.purgeAll': 'Empty the trash', 'trash.purgeAllQ': 'Empty the trash?', 'trash.purgeAllMsg': (p) => `${pl(p.n, 'record', 'records')} will be permanently deleted. This cannot be undone.`, 'trash.purgeAllOk': 'Delete permanently', 'trash.purgedAll': 'Trash emptied',
  ...
  'audit.purge': 'Deleted permanently', 'audit.share': 'Exported', 'audit.backup': 'Backup taken', 'audit.restore_backup': 'Backup restored', 'audit.wipe': 'All data deleted', 'audit.bulk': (p) => pl(p.n, 'record', 'records'),
  ...
  's.version': 'Curalis · version {v} · schema v{s}',
