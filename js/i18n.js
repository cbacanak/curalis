...
const TR = {
  ...
  'p.warn.label': 'Tıbbi uyarı', 'p.warn.anticoagulant': 'Antikoagülan', 'p.warn.smoking': 'Sigara', 'p.consent': 'Onam kapsamı', 'p.consentDoc': 'Onam belgesi', 'p.consentDoc.view': 'Belgeyi gör',
...
const EN = {
  ...
  'p.warn.label': 'Medical warning', 'p.warn.anticoagulant': 'Anticoagulant', 'p.warn.smoking': 'Smoker', 'p.consent': 'Consent scope', 'p.consentDoc': 'Consent document', 'p.consentDoc.view': 'View document',
